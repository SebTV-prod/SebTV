...
echo "$1er_Gua_content" > "$output_dir/La1ere_guadeloupe_metro.m3u8"
echo "$1er_Mar_content" > "$output_dir/La1ere_martinique_metro.m3u8"
echo "$1er_Guy_content" > "$output_dir/La1ere_guyane_metro.m3u8"
echo "$1er_May_content" > "$output_dir/La1ere_mayotte_metro.m3u8"
echo "$1er_Reu_content" > "$output_dir/La1ere_reunion_metro.m3u8"
echo "$1er_NC_content" > "$output_dir/La1ere_NC_metro.m3u8"
